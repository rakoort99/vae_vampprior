...
def load_static_mnist(args, **kwargs):
    ...
    if args.prior in ['vampprior_data', 'mbap_prior']:
        print('if statement: vamprior_data or mbap_prior')
        print('prior inputted:', args.prior)
        p_loader =  data_utils.DataLoader(train, batch_size=args.number_components, shuffle=True, **kwargs)
    elif args.prior == 'clust_db':
        print('if statement: clust_db')
        print('prior inputted:', args.prior)
        print("Generating cluster prior")
    ...
    return train_loader, val_loader, test_loader, p_loader, args
...
def load_dataset(args, **kwargs):
    ...
    if args.dataset_name == 'static_mnist':
        train_loader, val_loader, test_loader, p_loader, args = load_static_mnist(args, **kwargs)
